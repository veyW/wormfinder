...
%provide path to the directory with images as an argument
function wf = wormfinder6(mypath)
path_to_images=mypath;
%path_to_images='C:/Users/Olga/Desktop/Code/images/Ax_final/tubes_d3';
...
%image_w=imread('C:/Users/Olga/Desktop/Code/sample_img/milk_repeat_new_alg/G05.png');

image_gray=rgb2gray(image_w);
%image_hsv=rgb2hsv(image_w);
